...
void ShowWF(bool SaveWFPlot = false, string type = "Signal"){
  ...
  // path_store.push_back("../../Swan_TTrees/Configuration_P25/C3800_LSF1750_ThGUp1450_ThGDnGND_PMesh427_TPC1650_p1_0/");


  TH1D *h1 =  new TH1D("h1","", 100000, -20,80);
  TH1D *h_rms =  new TH1D("h_rms","", 100000, -20,80);
  TH1D *h_rms_dump =  new TH1D("h_rms_dump",";RMS (V); Entries", 1000, -0.1,0.1);
  ...
  std::unique_ptr<TFile> myFile(TFile::Open(path_store.at(0)+"WF_output_5_"+NSigmas_st+"RMS.root"));
