...
void MergeHistos(){
  ...
  path_store[0].push_back("../../../Swan_TTrees/Configuration_P23/C3800_LSF1750_ThGUp1400_ThGDnGND_PMesh427_TPC1650/");
  //path_store[0].push_back("../../Swan_TTrees/Configuration_18/C3500_LSF1480_ThGUp1400_ThGDnGND_PMesh0_TPC1650_b/");

  //
  path_store.push_back({});
  path_store[1].push_back("../../../Swan_TTrees/Configuration_P23/C3800_LSF1750_ThGUp1400_ThGDnGND_PMesh427_TPC1650_p2_0/");
  
  path_store.push_back({});
  path_store[2].push_back("../../../Swan_TTrees/Configuration_P23/C4300_LSF2300_ThGUp2000_ThGDnGND_PMesh427_TPC1650_p1_7/");
  ...
  for (int i(0); i < path_store.size(); i++){
    for (int j(0); j < path_store.at(i).size(); j++ ){
      ...
      if (i == 0)      file_store[i].push_back(TFile::Open(path_store.at(i).at(j)+"WF_output_1500_"+NSigmas+"RMS.root"));
      if (i == 1)      file_store[i].push_back(TFile::Open(path_store.at(i).at(j)+"WF_output_1500_"+NSigmas+"RMS.root"));
      if (i == 2)      file_store[i].push_back(TFile::Open(path_store.at(i).at(j)+"WF_output_5000_"+NSigmas+"RMS.root"));
  ...
  leg_WFsum->AddEntry(hWFsumFlat_st.at(0), "1 bar","l");//800
  leg_WFsum->AddEntry(hWFsumFlat_st.at(1),"2 bar","l");//800
  leg_WFsum->AddEntry(hWFsumFlat_st.at(2),"1.7 bar","l");//800
  ...
  mg_AbsYield->SetTitle("Absolute Number of Photons Detected; Pressure (bar); Photon Number");
  ...
  for (int i(0); i < hWFsumFlat_ind_st[0].at(0)->GetNbinsX(); i++){
    h_test->SetBinContent(i,hWFsumFlat_ind_st[2].at(0)->GetBinContent(i));
