...
void MergeHistos(){
  ...
  for (int i(0); i < path_store.size(); i++){//number of voltages on the mesh
	...
	err_abs_1bar.push_back(err_IntgWFSum_a[i]);
      } else if ( pen_mesh_p1_0.size()+ pen_mesh_p1_2.size() <= i && i < pen_mesh_p1_0.size()+pen_mesh_p1_2.size()+pen_mesh_p2_0.size()){
	err_abs_2bar.push_back(err_IntgWFSum_a[i]);
      } else if (i >= pen_mesh_p1_0.size()+pen_mesh_p1_2.size()+pen_mesh_p2_0.size()){
  ...
  cout << "abs_gain_p1_0 = [";
    for (int i(0); i< abs_gain_p1_0.size(); i++){
      cout << abs_gain_p1_0.at(i) ;
      if (i != abs_gain_p1_0.size() -1) cout << "," << endl;
    }
  cout << " ]" << endl;

  cout <<  "err_abs_1bar =[";
    for (int i(0); i< abs_gain_p1_0.size(); i++){
      cout << err_abs_1bar.at(i) ;
      if (i != abs_gain_p1_0.size() -1) cout << "," << endl;
    }
  cout << " ]" << endl;
  ...
  cout << "abs_gain_p1_5 = [";
    for (int i(0); i< abs_gain_p1_5.size(); i++){
      cout << abs_gain_p1_5.at(i) ;
      if (i != abs_gain_p1_5.size() -1) cout << "," << endl;
    }
  cout << " ]" << endl;

  cout <<  "err_abs_1_5bar =[";
    for (int i(0); i< abs_gain_p1_5.size(); i++){
      cout << err_abs_1_5bar.at(i) ;
      if (i != abs_gain_p1_5.size() -1) cout << "," << endl;
    }
  cout << " ]" << endl;
  ...
  cout <<  "E_N_mesh_p2_0 = [";
    for (int i(0); i< abs_gain_p2_0.size(); i++){
      cout << E_N_mesh_p2_0.at(i) ;
      if (i != abs_gain_p2_0.size() -1) cout << "," << endl;
    }
  cout << " ]" << endl;
  ...
  cout <<  "err_abs_2bar =[";
  for (int i(0); i< abs_gain_p2_0.size(); i++){
    cout << err_abs_2bar.at(i) ;
    if (i != err_abs_2bar.size() -1) cout << "," << endl;
  }
  cout << " ]" << endl;
