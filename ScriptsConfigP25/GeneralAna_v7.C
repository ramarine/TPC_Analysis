...
// if an event has a minimum in coincidentce with the trigger then this is not passed as signal.
...
int GeneralAna_v7(string path = ""){
  ...
  string prefix_path_data = "/srv/beegfs/scratch/users/a/amarinei/Swan_Data/Configuration_P25/Batch_2/";
  string path_prefix_AnaResults = "/srv/beegfs/scratch/users/a/amarinei/Swan_TTrees/Configuration_P25/Batch_2/";
