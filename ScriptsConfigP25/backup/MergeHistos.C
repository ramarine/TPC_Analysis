...
void MergeHistos(){
  ...
  std::vector<double> pen_mesh_p1_5 = {0.,100, 150, 300, 375, 480., 590, 640., 700., 800., 900.};
  ...
  int p1_5_ds = pen_mesh_p1_0.size(); // number of data sets taken at p1                                                                  
  ...
  //path_store.push_back({});
  // path_store.back().push_back("../../../Swan_TTrees/Configuration_P25/C4600_LSF2550_ThGUp2250_ThGDnGND_PMesh0_TPC1650_p2_0/");
  ...
  */
  ...
  leg->AddEntry(gr_p1_2, " 1.2 bar", "l");
