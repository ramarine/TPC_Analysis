...
void MergeHistos(){
  ...
  std::vector<double> data_set_p1;
  std::vector<double> data_set_p2_ThGEM2550;
  std::vector<double> data_set_p2_ThGEM2450;
  data_set_p1.push_back(SumOfWFSum_a.at(0));
  data_set_p1.push_back(SumOfWFSum_a.at(1));

  data_set_p2_ThGEM2550.push_back(SumOfWFSum_a.at(2));
  data_set_p2_ThGEM2550.push_back(SumOfWFSum_a.at(3));

  data_set_p2_ThGEM2450.push_back(SumOfWFSum_a.at(4));
  data_set_p2_ThGEM2450.push_back(SumOfWFSum_a.at(5));
  mesh_volt = {0, 427};
  
  TGraph *g_Abs = new TGraph(data_set_p1.size(),&mesh_volt[0] , &data_set_p1[0]);
  TGraph *g_Abs_2 = new TGraph(data_set_p2_ThGEM2550.size(),&mesh_volt[0] , &data_set_p2_ThGEM2550[0]);
  TGraph *g_Abs_3 = new TGraph(data_set_p2_ThGEM2450.size(),&mesh_volt[0] , &data_set_p2_ThGEM2450[0]);
  ...
  mg_AbsYield->Add(g_Abs_2,"ALP");
  mg_AbsYield->Add(g_Abs_3,"ALP");
  // mg_AbsYield->Add(g_ElAbs,"ALP");
  mg_AbsYield->Draw("ALP");

  auto leg_AbsYield = new TLegend(0.1,0.7,0.48,0.9);
  leg_AbsYield->AddEntry(g_Abs,"1 bar / ThGEM 1400","l");//800
  leg_AbsYield->AddEntry(g_Abs_2,"2 bar / ThGEM 2250","l");//800
  leg_AbsYield->AddEntry(g_Abs_3,"2 bar / ThGEM 2150","l");//800
  leg_AbsYield->Draw();
  gPad->Update();
